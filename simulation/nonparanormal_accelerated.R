...
criterion <- function(dat, vec, y){
  ...
  obj <- covarianceSelection::stepdown_path(dat, trials = 100, cores = ncores, verbose = F,
                                            iterations = 10, squared = F)
...
res <- simulation::simulation_generator(rule = rule, criterion = criterion,
                                        ...
                                        cores = NA, as_list = T,
                                        filepath = "../results/nonparanormal_accelerated_tmp.RData",
                                        verbose = T)
save.image("../results/nonparanormal_accelerated.RData")